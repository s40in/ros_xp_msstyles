...
macro(dir_to_num dir var)
    ...
    elseif(${dir} STREQUAL reactos/3rdParty)
        set(${var} 63)
	elseif(${dir} STREQUAL reactos/Resources/Themes/Neutrino)
        set(${var} 64)	
	elseif(${dir} STREQUAL reactos/Resources/Themes/Luna)
        set(${var} 65)	
	elseif(${dir} STREQUAL reactos/Resources/Themes/HaikuStyle)
        set(${var} 66)			
    else()
